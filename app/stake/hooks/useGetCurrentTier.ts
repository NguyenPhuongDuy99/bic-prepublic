...
export function useGetCurrentTier(
  ...
  const currentTier = (tiers as { totalStaked: bigint; maxTokens: bigint; annualInterestRate: bigint }[])
  ...
  const returnTier = {
    ...
    capacity: formatEther(currentTier.totalStaked) + '/' + formatEther(currentTier.maxTokens),
  }
  return {
    currentTierQueryKey: queryKey,
